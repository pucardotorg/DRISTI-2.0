...
**Always-on agent rails:** `.cursor/rules/` / `.Codex/rules/` (mandatory DS gate).
...
Skills live under `.Codex/skills/` and `.cursor/skills/`; roles under `.Codex/agents/`
