...
- Run `npm run dev`, `next dev`, or any restart of the app server
- `kill` node / next PIDs, or `rm -rf` `apps/dristi-app/.next` while it is up
- Start a second copy (Next.js will refuse, then someone kills the first)
